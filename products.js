...
router.put("/bulk-update", async (req, res) => {
  const updates = req.body; // Expect an array of { productId, ...updateData }

  try {
    // This assumes a promise-based approach to handling multiple updates,
    // which might need adjustment based on your database's API
    const results = await Promise.all(updates.map(({ productId, ...updateData }) =>
