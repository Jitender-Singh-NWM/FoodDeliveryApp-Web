...
export const baseURL =
  "http://localhost:5001/newfood-app-f02d1/us-central1/app";
...
export const UpdateAProduct = async (productId,updateData) => {
  try {
...
export const BulkUpdateProducts = async (updates) => {
  try {
    const res = await axios.put(`${baseURL}/api/products/bulk-update`, updates);
    return res.data.data;
  } catch (err) {
